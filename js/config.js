...
// ========== 护盾 ==========
export const SHIELD_ARC_DEFAULT = Math.PI / 3;    // 默认 60°（新手友好）
...
export const PROJECTILE_BASE_SPEED = 180;          // 基础速度 px/s（新手友好）
export const PROJECTILE_BASE_INTERVAL = 1600;       // 基础生成间隔 ms（新手友好）
...
export const DIFFICULTY = {
  spawnIntervalDecrease: 80,      // 每级生成间隔减少 ms
  minSpawnInterval: 500,          // 最低生成间隔 ms
  speedIncrease: 12,              // 每级速度增量 px/s
  fastChanceIncrease: 0.04,       // 每级快速弹幕概率增量
  fastChanceMax: 0.40,
  toughChanceIncrease: 0.02,
  toughChanceMax: 0.25,
  splitterChanceIncrease: 0.02,
  splitterChanceMax: 0.15,
  shieldShrinkPerLevel: Math.PI / 120, // 每级护盾缩小弧度（更慢）
  minShieldArc: Math.PI / 4.5,         // 最小护盾弧度 40°（原来30°太窄）
};
