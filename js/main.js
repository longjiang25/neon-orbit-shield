...
function init() {
  ...
  initInput(state, canvas);     // 设置 useJoystick + 初始化 DOM 摇杆
  showJoystickDOM(state);       // 根据屏幕状态显示/隐藏摇杆
  initAudio();
  initUI(state);
